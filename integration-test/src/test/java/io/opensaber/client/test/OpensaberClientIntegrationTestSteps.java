...
public class OpensaberClientIntegrationTestSteps extends RegistryTestBase implements En {
    ...
    private ResponseData<String> deleteEntity() throws ClientProtocolException, IOException, URISyntaxException{
        return client.deleteEntity(entityId, headers);
    }

    private ResponseData<String> readEntity() throws TransformationException, ClientProtocolException, IOException, URISyntaxException {
